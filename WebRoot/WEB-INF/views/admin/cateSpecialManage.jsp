			...
			<div class="modal-body">
                  <ul class="missionRecord animated">
						...
						<td>
							<div class="input-group">
								<div class="input-group-addon">类　　型</div>
									...
									<s:iterator value="status" status="c">
									<div class="radio radio-info radio-inline" title="${decription}" data-toggle="tooltip" data-placement="top">
                                        <input type="radio" id="inlineRadio${c.count}" value="${id }" name="ssCate.type.id">
                                        <label for="inlineRadio${c.count}">${name}</label>
                                    </div>
								</s:iterator>
								</div>
							</div>
					...
					<tr>
						...
						<div class="input-group" data-toggle="popover" data-placement="top" data-content="资源不能为空">
							<span class="input-group-addon">美食名称</span>
								<input type="hidden" id="source_id" name="ssCate.cate.id"/>
					...
					<tr>
						<td>
							<div class="input-group">
								<div class="input-group-addon">迷之描述</div>
								<input type="text" class="form-control decript" placeholder="填写一句话描述"
									name="ssCate.decript" data-toggle="tooltip" data-placement="top" />
							</div>
						</td>
					</tr>
					<tr>
...
<script src="js/admin/cateSpecialManage.js" type="text/javascript"></script>
<script src="js/admin/seriesAuto.js" type="text/javascript"></script>
<script type="text/javascript">
var AUTOURL="json/cate_findNameByKey";
