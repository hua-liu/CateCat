    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
        	<div class="modal-header">
                <h6 class="modal-title" style="margin:0;padding:0">预定确认</h6>
            </div>
            <div class="modal-body">
            	<div class="input-group m-b"><span class="input-group-addon">桌位</span>
                     	<span></span>
                 </div>
            	...
            	<div class="input-group m-b"><span class="input-group-addon">套餐</span>
                     <input type="text" name="height" placeholder="新布局的高度(单位像素)" class="form-control number">
                 </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-white" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-success createLayout" data-dismiss="modal">确定</button>
            </div>
        </div>
    </div>
</div>
