...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown" style="margin-top:10%;background:rgba(0,0,0,0.2);padding:10px;border-radius:10px">
        <div>
            ...
            <h3>欢迎注册 CateCat</h3>
            <p>创建一个Cat新账户</p>
            <form class="m-t" role="form" action="user_regist.action" method="post" modelAttribute="user"  autocomplete="off">
                ...
                <p class="text-center"><small>已经有账户了？</small><a href="user_loginPage.action">点此登录</a>
                </p>
            </form>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
			...
			$("input[name=username]").change(function(){
				var _this = this;
				if(this.value!=null){
					$.post("json/user_checkoutExist","type=username&value="+this.value,function(data) { // 此处可以
						console.log(data);
